<template>
  <div class="main-view">
    <!-- 列表 -->
    <information-detail-cell v-for="(item, index) in dataSource" 
                             :key="index"
                             :item="item">
    </information-detail-cell>
    <!-- 无数据 -->
...
<script>
import informationDetailCell from '@/pages/mine/Information/template/informationDetailCell'
export default {
  components:{
    informationDetailCell
  },
  data () {
    return {
      // 数据源
